 ...
 *
 */
public class MakananFragment extends Fragment implements OnItemClickListener<RvMainModel>{
    RecyclerView rvMain;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvMain = view.findViewById(R.id.rvMainRecyclerView);
        rvMain.setHasFixedSize(true);

        models.addAll(DataMakanan.getListData());

        GridLayoutManager gridLayoutManager = new GridLayoutManager(getActivity(),2,GridLayoutManager.VERTICAL, false);
        rvMain.setLayoutManager(gridLayoutManager);

        RvMainAdapter adapter = new RvMainAdapter(models);
    ...
    @Override
    public void onClick(RvMainModel rvMainModel) {
        Intent detailActivity = new Intent(getActivity(), DetailActivity.class);
        detailActivity.putExtra("MAKANAN_DETAIL", rvMainModel);
